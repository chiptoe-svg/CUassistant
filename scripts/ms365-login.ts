...
// consented to. Runtime calls in src/ms365.ts then request only the Mail + To Do
// scopes the current triage handler needs. The executable host-operation allow
// list lives in src/permissions.ts.
